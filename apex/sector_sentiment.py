...
def sector_sentiment_eastmoney_telemetry(store: SentimentStore, date: str | None) -> dict | None:
    ...
    public = {
        ...
        "business_success_rate": float(shown.get("business_success_rate") or 0),
        "comment_source": str(raw.get("comment_source") or "primary"),
        "comment_fallback_used": bool(raw.get("comment_fallback_used")),
        "comment_circuit_open": bool(raw.get("comment_circuit_open")),
